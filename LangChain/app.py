...
Always cite the sources from the document that you used to create the answer.
At the end of answer always say "Thanks for consulting me. Do you have any more question?
Chat History:
{chat_history}
